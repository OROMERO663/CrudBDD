...
public class Pokedex {
	 ...
	 * nuevo Objeto de la Clase Pokemon en la Lista de la Clase Pokedex. Si la Lista
	 * esta vacia añade directamente el nuevo Pokemon. Si el nombre del Pokemon ya
	 * estaba guardado saca mensaje por consola diciendo que el Pokemon ya esta en
	 * la lista y no lo guarda Mensaje por consola: confirma que se ha guardado el
	 * Pokemon. Mensaje por consola: el Pokemon esta repetido y pide que se
	 * introduzca un nuevo Pokemon.
	 * 
	 * @author Oscar
	 * @param nuevo Es el parametro con el que introducimos los atributos del
	 *              Pokemon.
	 */
			...
			if (miPokedex.isEmpty()) {
				...
				do {
					if (miPokedex.get(contador).getNombre().equals(nombre)) {
						System.out
								.println("El Pokèmon " + nombre + " está en tu Pokèdex. Prueba a añadir otro Pokèmon");
						encontrado = true;
					}
					contador++;
	 ...
	 * Pokemon introducido por el usuario con los existentes en la Lista. Si
	 * encuentra coincidencia muestra mensaje por consola con la informacion del
	 * Pokemon. Si no encuentra coincidencia muestra mensaje por consola diciendo
	 * que el Pokemon no aparece en la Lista. Mensajes por consola: muestra mensaje
	 * del Pokemon encontrado y sus atributos. Mensajes por consola: muestra mensaje
	 * de no haber encontrado el Pokemon buscado. Mensajes por consola: muestra
	 * mensaje de Error si la Lista estaba vacia.
	 * 
	 * @author Oscar
	 ...
	 * Pokemon introducido por el usuario con los existentes en la Lista. Si
	 * encuentra coincidencia muestra mensaje por consola con la informacion de
	 * todos los Pokemon del tipo buscado. Si no encuentra ningun Pokemon del tipo
	 * buscado muestra mensaje por consola diciendo que no hay Pokemon de ese tipo
	 * en la Lista. Mensajes por consola: muestra mensaje de los Pokemon encontrados
	 * y sus atributos. Mensajes por consola: muestra mensaje de no haber encontrado
	 * el Pokemon del tipo buscado.
	 * 
	 * @author Oscar
		...
		try {
			for (int i = 0; i < longitud; i++) {
				if (miPokedex.get(i).getTipo().equals(tipo)) {
					/*System.out.println("Pokèmon: " + miPokedex.get(i).getNombre() + ", Tipo: "
	 ...
	 * Pokemon introducido por el usuario con los existentes en la Lista. Si
	 * encuentra coincidencia muestra mensaje por consola con la informacion de
	 * todos los Pokemon de la region buscada. Si no encuentra ningun Pokemon de la
	 * region buscada, muestra mensaje por consola diciendo que no hay Pokemon de
	 * ese tipo en la Lista. Mensajes por consola: muestra mensaje de los Pokemon
	 * encontrados y sus atributos. Mensajes por consola: muestra mensaje de no
	 * haber encontrado el Pokemon de la region buscada.
	 * 
	 * @author Oscar
	...
	/**
	 * El metodo pokedexCompleta recorre la Lista miPokedex al completo y saca por
	 * consola la información de los atributos de los Pokemon guardados. Si la
	 * Pokedex esta vacia saca mensaje por consola informando. Mensajes por consola:
	 * muestra la Lista de Pokemon actualizada. Mensajes por consola: muestra
	 * mensaje de Pokedex vacia si la Lista miPokedex esta vacia.
	 * 
	 * @author Oscar
	 */
	/*
	 ...
	 * Pokemon introducido por el usuario con los existentes en la Lista. Si
	 * encuentra coincidencia pide por consola al usuario que modifique los
	 * atributos del Pokemon. Si no encuentra coincidencia muestra mensaje por
	 * consola diciendo que el Pokemon no aparece en la Lista. Mensajes por consola:
	 * muestra mensaje del Pokemon encontrado y pide al usuario los nuevos
	 * atributos. Mensajes por consola: muestra mensaje de no haber encontrado el
	 * Pokemon buscado. Mensajes por consola: muestra mensaje de Error si la Lista
	 * estaba vacia.
	 * 
	 * @author Oscar
			...
			if (miPokedex.isEmpty()) {
				...
				do {
					if (miPokedex.get(contador).getNombre().equals(nombre)) {
						...
						// modificamos el pokemon que hemos encontrado y lo guardamos en un objeto tipo
						// Pokemon para pasarlo al sql
						...
						miPokemon = new Pokemon(miPokedex.get(contador).getNombre(), miPokedex.get(contador).getTipo(),
								miPokedex.get(contador).getRegion());
	 ...
	 * Pokemon que quiere eliminar de la Lista y lo elimina. Si encuentra
	 * coincidencia muestra mensaje por consola de haber liberado al Pokemon. Si no
	 * encuentra coincidencia muestra mensaje por consola diciendo que el Pokemon no
	 * aparece en la Lista. Mensajes por consola: muestra mensaje de Error si la
	 * Lista estaba vacia.
	 * 
	 * @author Oscar
